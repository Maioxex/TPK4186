...
listOfTokens = Reader_TextfileToListOfTokens("test6.txt")

print(listOfTokens)
print(Token_GetType(listOfTokens, 0))
print(Token_GetString(listOfTokens, 0))
print(Token_GetPlacement(listOfTokens, 0))

print(Token_SplitNestedList(listOfTokens))
